 ...
 * 
 * Modified for Orange Pi Zero onboard LED mappings 28 March 2017
 *      by Priyend Somaroo, www.vardaan.com, 
 *
...
*/
typedef struct _pin {
    char name[20];          // The processor pin
...
/* Added Orange Pi Zero mappings.
   By Priyend Somaroo, c/o Vardaan Enterprises, www.vardaan.com
   28 March 2017
*/
    {"PIZERO",
        {
            ...
            { "PIZERO_POWER_LED", SUNXI_GPL(10), 1 },
            { "GREEN_LED", SUNXI_GPL(10), 1 },
            { "PIZERO_STATUS_LED", SUNXI_GPA(17), 2 },
            { "RED_LED", SUNXI_GPA(17), 2},
            {
                { 0,0,0 }
            },
        }
